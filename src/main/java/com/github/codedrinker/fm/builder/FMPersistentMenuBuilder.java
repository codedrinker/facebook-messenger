 ...
 */
public class FMPersistentMenuBuilder {
    private PersistentMenu persistentMenu;

    public FMPersistentMenuBuilder() {
        this.persistentMenu = new PersistentMenu();
    }

    public static FMPersistentMenuBuilder defaultBuilder() {
        return new FMPersistentMenuBuilder();
    }

    @SuppressWarnings("Duplicates")
    public FMPersistentMenuBuilder withMenu(MenuItem... menus) {
     ...
     */
    public FMPersistentMenuBuilder withLocale(String locale) {
     ...
     * 默认 false
     */
    public FMPersistentMenuBuilder withComposerInputDisabled(boolean disabled) {
